...
public class BRIT_114 extends TestBase {
     ...
     public void AdvancedSearch() {
          ...
          extentLogger = report.createTest("Advanced Search");
          ...
          Assert.assertTrue(pages.searchPage().filters_button.isDisplayed());
          Assert.assertTrue(pages.searchPage().GroupBy_button.isDisplayed());
          Assert.assertTrue(pages.searchPage().ClickOnFavoritesDropDown.isDisplayed());
