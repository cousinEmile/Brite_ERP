...
import static com.BriteErp.utilities.ApplicationConstants.LANDING_PAGE_TITLE;

public class BRIT2285 extends TestBase {

    /** http://jira.cybertekschool.com/browse/BRIT-2285 **/
    ...
    public void AdvancedSearchFilters_MyMeetings(){
        ...
        pages.calendar().close_mini_calendar.click();
