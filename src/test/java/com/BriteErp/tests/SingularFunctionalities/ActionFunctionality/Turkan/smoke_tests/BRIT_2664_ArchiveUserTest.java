...
public class BRIT_2664_ArchiveUserTest extends TestBase {
    ...
    public void BRIT_2659(){
        ...
        extentLogger.info("select archive from the actions drop down");
        ...
        pages.calendarListViewPage().archive.click();
        wait(5);
        System.out.println(pages.calendarListViewPage().archive.getText());
